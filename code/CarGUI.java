...
public class CarGUI extends JPanel {
    ...
    void setScene() {
        ...
        if (sceneStr.equals("Scene 1")) {
            endX = 440;
            endY = 250;
            obstacles.add(new Rectangle2D.Double(100, 400, 200, 180));
            obstacles.add(new Rectangle2D.Double(100, 200, 200, 150));
            
            obstacles.add(new Rectangle2D.Double(340, 450, 50, 80));
            
            obstacles.add(new Rectangle2D.Double(340, 350, 50, 400));
